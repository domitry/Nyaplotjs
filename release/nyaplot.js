...
define('utils/args2arr',[], function(){
    return function args2arr(args){
        return Array.prototype.slice.call(args);
    };
});

define('utils/parser_tools',[
    'underscore',
    'd3',
    'utils/args2arr'
...
define('layers/svg/glyph/scatter',[
    'underscore',
    'd3'
],function(_, d3){
    return [
...
define('layers/svg/glyph/histogram',[
    'underscore',
    'd3'
],function(_, d3){
    return [
...
define('layers/svg/glyph/vectors',[
    'underscore',
    'd3'
],function(_, d3){
    return [
...
define('layers/svg/glyph/circle',[
    'underscore',
    'd3'
], function(_, d3){
    return [
...
define('icons/cat.svg',[], function(){
    return "<!--?xml version=\"1.0\" encoding=\"utf-8\"?-->\
\
<svg version=\"1.1\" id=\"_x32_\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"0 0 512 512\" style=\"width: 23px; height: 23px; opacity: 1;\" xml:space=\"preserve\">\
<style type=\"text/css\">\
	.st0{fill:#dedede;}\
</style>\
<g>\
	<path class=\"st0\" d=\"M504.302,195.59c-10.618-6.362-29.71-43.514-33.959-47.755c-4.249-4.256-28.662-13.81-28.662-13.81\
		...
		c28.654-3.185,43.514-14.867,47.763-30.79C513.856,223.187,514.92,201.959,504.302,195.59z\"></path>\
</g>\
</svg>\
";
});

define('icons/save.svg',[], function(){
    return "<!--?xml version=\"1.0\" encoding=\"utf-8\"?-->\
\
...
<g>\
	<path class=\"st0\" d=\"M502.394,106.098L396.296,0h-15.162v121.49H130.866V0H60.27C26.987,0,0,26.987,0,60.271v391.458\
		...
		C512,120.591,508.542,112.256,502.394,106.098z M408.39,428.121H103.609V216.944H408.39V428.121z\" style=\"fill: rgb(222, 222, 222);\"></path>\
	<rect x=\"282.012\" class=\"st0\" width=\"68.027\" height=\"94.015\" style=\"fill: rgb(222, 222, 222);\"></rect>\
</g>\
</svg>";
});

define('layers/html/widget',[
    'underscore',
    'd3',
    'utils/svg_utils',
    'icons/cat.svg',
...
define('simple/glyphs/primitive',[
    'underscore',
    'utils/uuid'
], function(_, uuid){
...
define('utils/statistics',['underscore'], function(_){
...
define('simple/glyphs/shortcuts',[
    'underscore'
], function(_){
    return function(S, Glyphs){
...
define('main',['require','exports','module','underscore','layers/svg/_init','layers/svg/glyph/_init','layers/html/_init','layers/tool/_init','core','parser','d3','simple/_init'],function(require, exports, module){
